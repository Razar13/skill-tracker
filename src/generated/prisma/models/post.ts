...
export type postOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"authorId" | "content" | "createdAt" | "id" | "title" | "updatedAt", ExtArgs["result"]["post"]>
...
export interface postDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Posts and only return the `authorId`
   * const postWithAuthorIdOnly = await prisma.post.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Posts and only return the `authorId`
   * const postWithAuthorIdOnly = await prisma.post.updateManyAndReturn({
   *   select: { authorId: true },
   *   where: {
   *     // ... provide filter here
   *   },
